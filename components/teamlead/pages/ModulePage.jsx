...
const ModulePage = ({ title, type }) => {
    ...
    useEffect(() => {
        ...
        const fetchTeamMembers = async () => {
            try {
                ...
                // 5. Fetch tasks for performance calculation
                ...
                const mappedMembers = profiles.map(member => {
                    ...
                    return {
                        ...
                        role: member.project_role || member.role || 'N/A',
                        dept: teamName,
            ...
            try {
                ...
                const mappedStatus = profiles.map(member => {
                    ...
                    if (leaveSet.has(member.id)) {
                        ...
                        console.log(`  ✅ ${member.full_name} is ${availability}`);
    ...
    if (type === 'documents') return <ProjectDocuments userRole={userRole} addToast={addToast} />;
