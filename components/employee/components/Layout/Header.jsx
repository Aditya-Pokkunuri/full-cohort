            ...
            if (profiles) {
                profiles.forEach(p => {
                    results.push({
                        ...
                        path: '/student-dashboard/employees',
                        icon: User
                    });
                });
            }
            ...
            if (documents) {
                documents.forEach(d => {
                    results.push({
                        ...
                        path: '/student-dashboard/employees', // Documents are on employees page
                        icon: File
                    });
                });
            }
    ...
    return (
        <header style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 'var(--spacing-md)' }}>
                <h2 style={{ fontSize: '1.5rem', fontWeight: 'bold' }}>{userRole === 'employee' ? 'STUDENT' : (userRole ? userRole.toUpperCase() : 'DASHBOARD')}</h2>
            </div>
