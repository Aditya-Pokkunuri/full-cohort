...
const AttendanceTracker = () => {
    ...
    const handleMainAction = async () => {
        ...
        try {
            if (status === 'checked-out') {
                ...
                // Start task timers for time-based tracking
                await supabase.rpc('start_task_timers', { p_user_id: userId });
    ...
    const performCheckOut = async () => {
        ...
        try {
            ...
            // Stop task timers for time-based tracking
            await supabase.rpc('stop_task_timers', { p_user_id: userId });
